...
export default function PlantDetailScreen() {
    ...
    useEffect(() => {
        const fetchWiki = async () => {
            ...
            try {
                ...
                // Optional: persist updated discovery
    ...
    return (
        <ScrollView style={styles.container}>
            {/* Hero Image */}
            <Image source={{ uri: discovery.photoUri }} style={styles.image} />

            {/* Title + Confidence */}
            <View style={styles.headerSection}>
                {wikiInfo && <Text style={styles.title}>{wikiInfo?.nativeName || discovery.speciesName}</Text>}
            ...
            {discovery.location && (
                <View style={styles.section}>
                    ...
                    <Text style={styles.sectionText}>
                        {discovery.location.latitude.toFixed(5)}, {discovery.location.longitude.toFixed(5)}
                    </Text>
                </View>
            )}
        </ScrollView>
